...
//注意调用：CryptoJS.SHA1(str).toString();
//
//
//排序方法
...
// 获取签名
function computedSign(data,method,timestamp){
  //var appid = "wx0c462cc5c5cac6c4";
  var appkey = 'C7C90874E9A9FDE4';
  var appsecret = "300CB417884366020273847CD6AE94CC4E6FB16B";
...
//判断是get请求还是post请求
  ...
  //console.log(sort);
  ////获取签名
  var sign = CryptoJS.SHA1(sort + appsecret).toString();
  //console.log(sort + appsecret);
...
//console.log(computedSign({"id":"27432","name":"hshsh"},'GET')); 